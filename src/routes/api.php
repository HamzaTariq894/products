...
Route::get('demo', function() {
    ...
    Route::group(['prefix' => 'api/v1/product'],function(){
        ...
        Route::post('add/product/rates', [\Teamincredibles\Products\Http\Controllers\API\V1\RateController::class, 'addProductRates'])->name('product.add.product.rates');
        Route::get('product/delete',[\Teamincredibles\Products\Http\Controllers\API\V1\ProductController::class, 'productDelete'])->name('product.product.delete');
        ...
        Route::post('edit/product/rates',[\Teamincredibles\Products\Http\Controllers\API\V1\RateController::class, 'editProductRates'])->name('product.edit.product.rates');
        Route::post('add/product/stock',[\Teamincredibles\Products\Http\Controllers\API\V1\StockController::class, 'addProductStock'])->name('product.add.product.stock');
        Route::post('edit/product/stocks',[\Teamincredibles\Products\Http\Controllers\API\V1\StockController::class, 'editProductStocks'])->name('product.edit.product.stocks');
        Route::get('stock/delete',[\Teamincredibles\Products\Http\Controllers\API\V1\StockController::class, 'stockDelete'])->name('product.stock.delete');
        Route::get('rate/delete',[\Teamincredibles\Products\Http\Controllers\API\V1\RateController::class, 'rateDelete'])->name('product.rate.delete');
        ...
        Route::get('warehouse/delete',[\Teamincredibles\Products\Http\Controllers\API\V1\WareHouseController::class, 'deleteWareHouse'])->name('product.warehouse.delete');
        ...
        Route::get('category/delete',[\Teamincredibles\Products\Http\Controllers\API\V1\CategoryController::class, 'deleteCategory'])->name('product.category.delete');
        ...
        Route::get('delete/measurementunit',[\Teamincredibles\Products\Http\Controllers\API\V1\Measurement_UnitController::class, 'deleteMeasurementUnit'])->name('product.measurementunit.delete');
