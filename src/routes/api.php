...
Route::get('demo', function() {
    ...
    Route::group(['prefix' => 'api/v1/product'],function(){
        ...
        Route::post('get/product/stocks',[\Teamincredibles\Products\Http\Controllers\API\V1\ProductController::class, 'getProductStocks'])->name('product.get.product.stocks');       
